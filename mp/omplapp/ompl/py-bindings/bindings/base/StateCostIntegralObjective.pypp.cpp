...
#include "StateCostIntegralObjective.pypp.hpp"

namespace bp = boost::python;

struct StateCostIntegralObjective_wrapper : ompl::base::StateCostIntegralObjective, bp::wrapper< ompl::base::StateCostIntegralObjective > {

    StateCostIntegralObjective_wrapper(::ompl::base::SpaceInformationPtr const & si, bool enableMotionCostInterpolation=false )
    : ompl::base::StateCostIntegralObjective( si, enableMotionCostInterpolation )
      , bp::wrapper< ompl::base::StateCostIntegralObjective >(){
        // constructor
    ...
    virtual ::ompl::base::Cost motionCost( ::ompl::base::State const * s1, ::ompl::base::State const * s2 ) const  {
        if( bp::override func_motionCost = this->get_override( "motionCost" ) )
            ...
            return this->ompl::base::StateCostIntegralObjective::motionCost( boost::python::ptr(s1), boost::python::ptr(s2) );
        }
    }
    
    ::ompl::base::Cost default_motionCost( ::ompl::base::State const * s1, ::ompl::base::State const * s2 ) const  {
        return ompl::base::StateCostIntegralObjective::motionCost( boost::python::ptr(s1), boost::python::ptr(s2) );
    }

    ::ompl::base::Cost trapezoid( ::ompl::base::Cost c1, ::ompl::base::Cost c2, double dist ) const {
        return ompl::base::StateCostIntegralObjective::trapezoid( c1, c2, dist );
    }
...
void register_StateCostIntegralObjective_class(){
    ...
    { //::ompl::base::StateCostIntegralObjective
        typedef bp::class_< StateCostIntegralObjective_wrapper, bp::bases< ompl::base::OptimizationObjective >, boost::noncopyable > StateCostIntegralObjective_exposer_t;
        StateCostIntegralObjective_exposer_t StateCostIntegralObjective_exposer = StateCostIntegralObjective_exposer_t( "StateCostIntegralObjective", bp::init< ompl::base::SpaceInformationPtr const &, bp::optional< bool > >(( bp::arg("si"), bp::arg("enableMotionCostInterpolation")=(bool)(false) )) );
        bp::scope StateCostIntegralObjective_scope( StateCostIntegralObjective_exposer );
        bp::implicitly_convertible< ompl::base::SpaceInformationPtr const &, ompl::base::StateCostIntegralObjective >();
        { //::ompl::base::StateCostIntegralObjective::isMotionCostInterpolationEnabled
        
            typedef bool ( ::ompl::base::StateCostIntegralObjective::*isMotionCostInterpolationEnabled_function_type)(  ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "isMotionCostInterpolationEnabled"
                , isMotionCostInterpolationEnabled_function_type( &::ompl::base::StateCostIntegralObjective::isMotionCostInterpolationEnabled ) );
        
        }
        { //::ompl::base::StateCostIntegralObjective::motionCost
        
            typedef ::ompl::base::Cost ( ::ompl::base::StateCostIntegralObjective::*motionCost_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_motionCost_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "motionCost"
                , motionCost_function_type(&::ompl::base::StateCostIntegralObjective::motionCost)
                , default_motionCost_function_type(&StateCostIntegralObjective_wrapper::default_motionCost)
                , ( bp::arg("s1"), bp::arg("s2") ) );
        
        }
        { //::ompl::base::StateCostIntegralObjective::trapezoid
        
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*trapezoid_function_type)( ::ompl::base::Cost,::ompl::base::Cost,double ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "trapezoid"
                , trapezoid_function_type( &StateCostIntegralObjective_wrapper::trapezoid )
                , ( bp::arg("c1"), bp::arg("c2"), bp::arg("dist") ) );
        ...
        { //::ompl::base::OptimizationObjective::averageStateCost
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_averageStateCost_function_type)( unsigned int ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "averageStateCost"
                , averageStateCost_function_type(&::ompl::base::OptimizationObjective::averageStateCost)
                , default_averageStateCost_function_type(&StateCostIntegralObjective_wrapper::default_averageStateCost)
                , ( bp::arg("numStates") ) );
        ...
        { //::ompl::base::OptimizationObjective::combineCosts
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_combineCosts_function_type)( ::ompl::base::Cost,::ompl::base::Cost ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "combineCosts"
                , combineCosts_function_type(&::ompl::base::OptimizationObjective::combineCosts)
                , default_combineCosts_function_type(&StateCostIntegralObjective_wrapper::default_combineCosts)
                , ( bp::arg("c1"), bp::arg("c2") ) );
        ...
        { //::ompl::base::OptimizationObjective::getCost
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_getCost_function_type)( ::ompl::base::Path const & ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "getCost"
                , getCost_function_type(&::ompl::base::OptimizationObjective::getCost)
                , default_getCost_function_type(&StateCostIntegralObjective_wrapper::default_getCost)
                , ( bp::arg("path") ) );
        ...
        { //::ompl::base::OptimizationObjective::identityCost
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_identityCost_function_type)(  ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "identityCost"
                , identityCost_function_type(&::ompl::base::OptimizationObjective::identityCost)
                , default_identityCost_function_type(&StateCostIntegralObjective_wrapper::default_identityCost) );
        ...
        { //::ompl::base::OptimizationObjective::infiniteCost
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_infiniteCost_function_type)(  ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "infiniteCost"
                , infiniteCost_function_type(&::ompl::base::OptimizationObjective::infiniteCost)
                , default_infiniteCost_function_type(&StateCostIntegralObjective_wrapper::default_infiniteCost) );
        ...
        { //::ompl::base::OptimizationObjective::initialCost
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_initialCost_function_type)( ::ompl::base::State const * ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "initialCost"
                , initialCost_function_type(&::ompl::base::OptimizationObjective::initialCost)
                , default_initialCost_function_type(&StateCostIntegralObjective_wrapper::default_initialCost)
                , ( bp::arg("s") ) );
        ...
        { //::ompl::base::OptimizationObjective::isCostBetterThan
            ...
            typedef bool ( StateCostIntegralObjective_wrapper::*default_isCostBetterThan_function_type)( ::ompl::base::Cost,::ompl::base::Cost ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "isCostBetterThan"
                , isCostBetterThan_function_type(&::ompl::base::OptimizationObjective::isCostBetterThan)
                , default_isCostBetterThan_function_type(&StateCostIntegralObjective_wrapper::default_isCostBetterThan)
                , ( bp::arg("c1"), bp::arg("c2") ) );
        ...
        { //::ompl::base::OptimizationObjective::isSatisfied
            ...
            typedef bool ( StateCostIntegralObjective_wrapper::*default_isSatisfied_function_type)( ::ompl::base::Cost ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "isSatisfied"
                , isSatisfied_function_type(&::ompl::base::OptimizationObjective::isSatisfied)
                , default_isSatisfied_function_type(&StateCostIntegralObjective_wrapper::default_isSatisfied)
                , ( bp::arg("c") ) );
        ...
        { //::ompl::base::OptimizationObjective::isSymmetric
            ...
            typedef bool ( StateCostIntegralObjective_wrapper::*default_isSymmetric_function_type)(  ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "isSymmetric"
                , isSymmetric_function_type(&::ompl::base::OptimizationObjective::isSymmetric)
                , default_isSymmetric_function_type(&StateCostIntegralObjective_wrapper::default_isSymmetric) );
        ...
        { //::ompl::base::OptimizationObjective::motionCostHeuristic
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_motionCostHeuristic_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "motionCostHeuristic"
                , motionCostHeuristic_function_type(&::ompl::base::OptimizationObjective::motionCostHeuristic)
                , default_motionCostHeuristic_function_type(&StateCostIntegralObjective_wrapper::default_motionCostHeuristic)
                , ( bp::arg("s1"), bp::arg("s2") ) );
        ...
        { //::ompl::base::OptimizationObjective::stateCost
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_stateCost_function_type)( ::ompl::base::State const * ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "stateCost"
                , stateCost_function_type(&::ompl::base::OptimizationObjective::stateCost)
                , default_stateCost_function_type(&StateCostIntegralObjective_wrapper::default_stateCost)
                , ( bp::arg("s") ) );
        ...
        { //::ompl::base::OptimizationObjective::terminalCost
            ...
            typedef ::ompl::base::Cost ( StateCostIntegralObjective_wrapper::*default_terminalCost_function_type)( ::ompl::base::State const * ) const;
            
            StateCostIntegralObjective_exposer.def( 
                "terminalCost"
                , terminalCost_function_type(&::ompl::base::OptimizationObjective::terminalCost)
                , default_terminalCost_function_type(&StateCostIntegralObjective_wrapper::default_terminalCost)
                , ( bp::arg("s") ) );
