...
#include "BlimpPlanning.pypp.hpp"

namespace bp = boost::python;

struct BlimpPlanning_wrapper : ompl::app::BlimpPlanning, bp::wrapper< ompl::app::BlimpPlanning > {

    BlimpPlanning_wrapper(ompl::app::BlimpPlanning const & arg )
    : ompl::app::BlimpPlanning( arg )
      , bp::wrapper< ompl::app::BlimpPlanning >(){
        // copy constructor
        
    }

    BlimpPlanning_wrapper( )
    : ompl::app::BlimpPlanning( )
      , bp::wrapper< ompl::app::BlimpPlanning >(){
        // null constructor
...
void register_BlimpPlanning_class(){
    ...
    { //::ompl::app::BlimpPlanning
        typedef bp::class_< BlimpPlanning_wrapper, bp::bases< ompl::app::AppBase< (ompl::app::AppType)1 > > > BlimpPlanning_exposer_t;
        BlimpPlanning_exposer_t BlimpPlanning_exposer = BlimpPlanning_exposer_t( "BlimpPlanning", bp::init< >() );
        bp::scope BlimpPlanning_scope( BlimpPlanning_exposer );
        { //::ompl::app::BlimpPlanning::constructControlSpace
        
            typedef ::ompl::control::ControlSpacePtr ( *constructControlSpace_function_type )(  );
            
            BlimpPlanning_exposer.def( 
                "constructControlSpace"
                , constructControlSpace_function_type( &BlimpPlanning_wrapper::constructControlSpace ) );
        ...
        { //::ompl::app::BlimpPlanning::constructStateSpace
            ...
            BlimpPlanning_exposer.def( 
                "constructStateSpace"
                , constructStateSpace_function_type( &BlimpPlanning_wrapper::constructStateSpace ) );
        ...
        { //::ompl::app::BlimpPlanning::getDefaultStartState
            ...
            typedef ::ompl::base::ScopedState< ompl::base::StateSpace > ( BlimpPlanning_wrapper::*default_getDefaultStartState_function_type)(  ) const;
            
            BlimpPlanning_exposer.def( 
                "getDefaultStartState"
                , getDefaultStartState_function_type(&::ompl::app::BlimpPlanning::getDefaultStartState)
                , default_getDefaultStartState_function_type(&BlimpPlanning_wrapper::default_getDefaultStartState) );
        ...
        { //::ompl::app::BlimpPlanning::getFullStateFromGeometricComponent
            ...
            typedef ::ompl::base::ScopedState< ompl::base::StateSpace > ( BlimpPlanning_wrapper::*default_getFullStateFromGeometricComponent_function_type)( ::ompl::base::ScopedState< ompl::base::StateSpace > const & ) const;
            ...
            BlimpPlanning_exposer.def( 
                ...
                , default_getFullStateFromGeometricComponent_function_type(&BlimpPlanning_wrapper::default_getFullStateFromGeometricComponent)
                , ( bp::arg("state") ) );
        
        }
        { //::ompl::app::BlimpPlanning::getGeometricComponentStateInternal
        
            typedef ::ompl::base::State const * ( BlimpPlanning_wrapper::*getGeometricComponentStateInternal_function_type)( ::ompl::base::State const *,unsigned int ) const;
            
            BlimpPlanning_exposer.def( 
                "getGeometricComponentStateInternal"
                , getGeometricComponentStateInternal_function_type( &BlimpPlanning_wrapper::default_getGeometricComponentStateInternal )
        ...
        { //::ompl::app::BlimpPlanning::getRobotCount
            ...
            typedef unsigned int ( BlimpPlanning_wrapper::*default_getRobotCount_function_type)(  ) const;
            
            BlimpPlanning_exposer.def( 
                "getRobotCount"
                , getRobotCount_function_type(&::ompl::app::BlimpPlanning::getRobotCount)
                , default_getRobotCount_function_type(&BlimpPlanning_wrapper::default_getRobotCount) );
        ...
        { //::ompl::app::BlimpPlanning::isSelfCollisionEnabled
            ...
            typedef bool ( BlimpPlanning_wrapper::*default_isSelfCollisionEnabled_function_type)(  ) const;
            
            BlimpPlanning_exposer.def( 
                "isSelfCollisionEnabled"
                , isSelfCollisionEnabled_function_type(&::ompl::app::BlimpPlanning::isSelfCollisionEnabled)
                , default_isSelfCollisionEnabled_function_type(&BlimpPlanning_wrapper::default_isSelfCollisionEnabled) );
        
        }
        { //::ompl::app::BlimpPlanning::ode
        
            typedef void ( BlimpPlanning_wrapper::*ode_function_type)( ::std::vector< double > const &,::ompl::control::Control const *,::std::vector< double > & ) ;
            
            BlimpPlanning_exposer.def( 
                "ode"
                , ode_function_type( &BlimpPlanning_wrapper::default_ode )
                , ( bp::arg("q"), bp::arg("ctrl"), bp::arg("qdot") ) );
        
        }
        { //::ompl::app::BlimpPlanning::postPropagate
        
            typedef void ( BlimpPlanning_wrapper::*postPropagate_function_type)( ::ompl::base::State const *,::ompl::control::Control const *,double const,::ompl::base::State * ) ;
            
            BlimpPlanning_exposer.def( 
                "postPropagate"
                , postPropagate_function_type( &BlimpPlanning_wrapper::postPropagate )
        ...
        { //::ompl::app::BlimpPlanning::setDefaultBounds
            ...
            typedef void ( BlimpPlanning_wrapper::*default_setDefaultBounds_function_type)(  ) ;
            
            BlimpPlanning_exposer.def( 
                "setDefaultBounds"
                , setDefaultBounds_function_type(&::ompl::app::BlimpPlanning::setDefaultBounds)
                , default_setDefaultBounds_function_type(&BlimpPlanning_wrapper::default_setDefaultBounds) );
        
        }
        { //::ompl::app::RigidBodyGeometry::computeGeometrySpecification
        
            typedef void ( BlimpPlanning_wrapper::*computeGeometrySpecification_function_type)(  ) ;
            
            BlimpPlanning_exposer.def( 
                "computeGeometrySpecification"
                , computeGeometrySpecification_function_type( &BlimpPlanning_wrapper::computeGeometrySpecification ) );
        
        }
        { //::ompl::app::AppBase< (ompl::app::AppType)1 >::getGeometricComponentState
        
            typedef ompl::app::BlimpPlanning exported_class_t;
            ...
            typedef ::ompl::base::ScopedState< ompl::base::StateSpace > ( BlimpPlanning_wrapper::*default_getGeometricComponentState_function_type)( ::ompl::base::ScopedState< ompl::base::StateSpace > const &,unsigned int ) const;
            ...
            BlimpPlanning_exposer.def( 
                ...
                , default_getGeometricComponentState_function_type(&BlimpPlanning_wrapper::default_getGeometricComponentState)
        ...
        { //::ompl::app::AppBase< (ompl::app::AppType)1 >::inferEnvironmentBounds
            ...
            typedef void ( BlimpPlanning_wrapper::*default_inferEnvironmentBounds_function_type)(  ) ;
            
            BlimpPlanning_exposer.def( 
                "inferEnvironmentBounds"
                , inferEnvironmentBounds_function_type(&::ompl::app::AppBase< (ompl::app::AppType)1 >::inferEnvironmentBounds)
                , default_inferEnvironmentBounds_function_type(&BlimpPlanning_wrapper::default_inferEnvironmentBounds) );
        ...
        { //::ompl::app::AppBase< (ompl::app::AppType)1 >::inferProblemDefinitionBounds
            ...
            typedef void ( BlimpPlanning_wrapper::*default_inferProblemDefinitionBounds_function_type)(  ) ;
            ...
            BlimpPlanning_exposer.def( 
                ...
                , default_inferProblemDefinitionBounds_function_type(&BlimpPlanning_wrapper::default_inferProblemDefinitionBounds) );
        ...
        { //::ompl::app::AppBase< (ompl::app::AppType)1 >::setup
            ...
            typedef void ( BlimpPlanning_wrapper::*default_setup_function_type)(  ) ;
            
            BlimpPlanning_exposer.def( 
                "setup"
                , setup_function_type(&::ompl::app::AppBase< (ompl::app::AppType)1 >::setup)
                , default_setup_function_type(&BlimpPlanning_wrapper::default_setup) );
        
        }
        BlimpPlanning_exposer.staticmethod( "constructControlSpace" );
        BlimpPlanning_exposer.staticmethod( "constructStateSpace" );
        BlimpPlanning_exposer.def("solve", (::ompl::base::PlannerStatus(::ompl::app::BlimpPlanning::*)( double ))(&::ompl::app::BlimpPlanning::solve), (bp::arg("solveTime")) );
        BlimpPlanning_exposer.def("solve", (::ompl::base::PlannerStatus(::ompl::app::BlimpPlanning::*)( const ompl::base::PlannerTerminationCondition& ))(&::ompl::app::BlimpPlanning::solve), (bp::arg("ptc")) );
        BlimpPlanning_exposer.def("clear", &BlimpPlanning_wrapper::clear);
        BlimpPlanning_exposer.def("getStateSpace", &::ompl::control::SimpleSetup::getStateSpace, bp::return_value_policy< bp::copy_const_reference >());
    }
