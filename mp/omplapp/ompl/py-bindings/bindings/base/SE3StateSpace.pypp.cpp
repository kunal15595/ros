...
#include "SE3StateSpace.pypp.hpp"

namespace bp = boost::python;

struct SE3StateSpace_wrapper : ompl::base::SE3StateSpace, bp::wrapper< ompl::base::SE3StateSpace > {

    SE3StateSpace_wrapper( )
    : ompl::base::SE3StateSpace( )
      , bp::wrapper< ompl::base::SE3StateSpace >(){
        // null constructor
    ...
    virtual ::ompl::base::State * allocState(  ) const  {
        if( bp::override func_allocState = this->get_override( "allocState" ) )
            ...
            return this->ompl::base::SE3StateSpace::allocState(  );
        }
    }
    
    ::ompl::base::State * default_allocState(  ) const  {
        return ompl::base::SE3StateSpace::allocState( );
    }
    ...
    virtual void freeState( ::ompl::base::State * state ) const  {
        if( bp::override func_freeState = this->get_override( "freeState" ) )
            ...
            this->ompl::base::SE3StateSpace::freeState( boost::python::ptr(state) );
        }
    }
    
    void default_freeState( ::ompl::base::State * state ) const  {
        ompl::base::SE3StateSpace::freeState( boost::python::ptr(state) );
    }
    ...
    virtual void registerProjections(  ) {
        if( bp::override func_registerProjections = this->get_override( "registerProjections" ) )
            ...
            this->ompl::base::SE3StateSpace::registerProjections(  );
        }
    }
    
    void default_registerProjections(  ) {
        ompl::base::SE3StateSpace::registerProjections( );
    }
...
void register_SE3StateSpace_class(){
    ...
    { //::ompl::base::SE3StateSpace
        typedef bp::class_< SE3StateSpace_wrapper, bp::bases< ompl::base::CompoundStateSpace >, boost::noncopyable > SE3StateSpace_exposer_t;
        SE3StateSpace_exposer_t SE3StateSpace_exposer = SE3StateSpace_exposer_t( "SE3StateSpace", bp::init< >() );
        bp::scope SE3StateSpace_scope( SE3StateSpace_exposer );
        { //::ompl::base::SE3StateSpace::StateType
            typedef bp::class_< ompl::base::SE3StateSpace::StateType, bp::bases< ompl::base::CompoundState >, boost::noncopyable > SE3StateInternal_exposer_t;
            SE3StateInternal_exposer_t SE3StateInternal_exposer = SE3StateInternal_exposer_t( "SE3StateInternal", bp::init< >() );
            bp::scope SE3StateInternal_scope( SE3StateInternal_exposer );
            { //::ompl::base::SE3StateSpace::StateType::getX
            
                typedef double ( ::ompl::base::SE3StateSpace::StateType::*getX_function_type)(  ) const;
                
                SE3StateInternal_exposer.def( 
                    "getX"
                    , getX_function_type( &::ompl::base::SE3StateSpace::StateType::getX ) );
            
            }
            { //::ompl::base::SE3StateSpace::StateType::getY
            
                typedef double ( ::ompl::base::SE3StateSpace::StateType::*getY_function_type)(  ) const;
                
                SE3StateInternal_exposer.def( 
                    "getY"
                    , getY_function_type( &::ompl::base::SE3StateSpace::StateType::getY ) );
            
            }
            { //::ompl::base::SE3StateSpace::StateType::getZ
            
                typedef double ( ::ompl::base::SE3StateSpace::StateType::*getZ_function_type)(  ) const;
                
                SE3StateInternal_exposer.def( 
                    "getZ"
                    , getZ_function_type( &::ompl::base::SE3StateSpace::StateType::getZ ) );
            
            }
            { //::ompl::base::SE3StateSpace::StateType::rotation
            
                typedef ::ompl::base::SO3StateSpace::StateType const & ( ::ompl::base::SE3StateSpace::StateType::*rotation_function_type)(  ) const;
                
                SE3StateInternal_exposer.def( 
                    "rotation"
                    , rotation_function_type( &::ompl::base::SE3StateSpace::StateType::rotation )
                    , bp::return_value_policy< bp::copy_const_reference >() );
            
            }
            { //::ompl::base::SE3StateSpace::StateType::rotation
            
                typedef ::ompl::base::SO3StateSpace::StateType & ( ::ompl::base::SE3StateSpace::StateType::*rotation_function_type)(  ) ;
            ...
            { //::ompl::base::SE3StateSpace::StateType::setX
            
                typedef void ( ::ompl::base::SE3StateSpace::StateType::*setX_function_type)( double ) ;
                
                SE3StateInternal_exposer.def( 
                    "setX"
                    , setX_function_type( &::ompl::base::SE3StateSpace::StateType::setX )
                    , ( bp::arg("x") ) );
            
            }
            { //::ompl::base::SE3StateSpace::StateType::setXYZ
            
                typedef void ( ::ompl::base::SE3StateSpace::StateType::*setXYZ_function_type)( double,double,double ) ;
                
                SE3StateInternal_exposer.def( 
                    "setXYZ"
                    , setXYZ_function_type( &::ompl::base::SE3StateSpace::StateType::setXYZ )
                    , ( bp::arg("x"), bp::arg("y"), bp::arg("z") ) );
            
            }
            { //::ompl::base::SE3StateSpace::StateType::setY
            
                typedef void ( ::ompl::base::SE3StateSpace::StateType::*setY_function_type)( double ) ;
                
                SE3StateInternal_exposer.def( 
                    "setY"
                    , setY_function_type( &::ompl::base::SE3StateSpace::StateType::setY )
                    , ( bp::arg("y") ) );
            
            }
            { //::ompl::base::SE3StateSpace::StateType::setZ
            
                typedef void ( ::ompl::base::SE3StateSpace::StateType::*setZ_function_type)( double ) ;
                
                SE3StateInternal_exposer.def( 
                    "setZ"
                    , setZ_function_type( &::ompl::base::SE3StateSpace::StateType::setZ )
                    , ( bp::arg("z") ) );
        ...
        { //::ompl::base::SE3StateSpace::allocState
            ...
            typedef ::ompl::base::State * ( ::ompl::base::SE3StateSpace::*allocState_function_type)(  ) const;
            typedef ::ompl::base::State * ( SE3StateSpace_wrapper::*default_allocState_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "allocState"
                , allocState_function_type(&::ompl::base::SE3StateSpace::allocState)
                , default_allocState_function_type(&SE3StateSpace_wrapper::default_allocState)
                , bp::return_value_policy< bp::reference_existing_object >() );
        
        }
        { //::ompl::base::SE3StateSpace::freeState
        
            typedef void ( ::ompl::base::SE3StateSpace::*freeState_function_type)( ::ompl::base::State * ) const;
            typedef void ( SE3StateSpace_wrapper::*default_freeState_function_type)( ::ompl::base::State * ) const;
            
            SE3StateSpace_exposer.def( 
                "freeState"
                , freeState_function_type(&::ompl::base::SE3StateSpace::freeState)
                , default_freeState_function_type(&SE3StateSpace_wrapper::default_freeState)
                , ( bp::arg("state") ) );
        
        }
        { //::ompl::base::SE3StateSpace::getBounds
        
            typedef ::ompl::base::RealVectorBounds const & ( ::ompl::base::SE3StateSpace::*getBounds_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "getBounds"
                , getBounds_function_type( &::ompl::base::SE3StateSpace::getBounds )
                , bp::return_value_policy< bp::copy_const_reference >() );
        
        }
        { //::ompl::base::SE3StateSpace::registerProjections
        
            typedef void ( ::ompl::base::SE3StateSpace::*registerProjections_function_type)(  ) ;
            typedef void ( SE3StateSpace_wrapper::*default_registerProjections_function_type)(  ) ;
            
            SE3StateSpace_exposer.def( 
                "registerProjections"
                , registerProjections_function_type(&::ompl::base::SE3StateSpace::registerProjections)
                , default_registerProjections_function_type(&SE3StateSpace_wrapper::default_registerProjections) );
        
        }
        { //::ompl::base::SE3StateSpace::setBounds
        
            typedef void ( ::ompl::base::SE3StateSpace::*setBounds_function_type)( ::ompl::base::RealVectorBounds const & ) ;
            
            SE3StateSpace_exposer.def( 
                "setBounds"
                , setBounds_function_type( &::ompl::base::SE3StateSpace::setBounds )
                , ( bp::arg("bounds") ) );
        ...
        { //::ompl::base::CompoundStateSpace::allocDefaultStateSampler
            ...
            typedef ::ompl::base::StateSamplerPtr ( SE3StateSpace_wrapper::*default_allocDefaultStateSampler_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "allocDefaultStateSampler"
                , allocDefaultStateSampler_function_type(&::ompl::base::CompoundStateSpace::allocDefaultStateSampler)
                , default_allocDefaultStateSampler_function_type(&SE3StateSpace_wrapper::default_allocDefaultStateSampler) );
        
        }
        { //::ompl::base::CompoundStateSpace::allocStateComponents
        
            typedef void ( SE3StateSpace_wrapper::*allocStateComponents_function_type)( ::ompl::base::CompoundState * ) const;
            
            SE3StateSpace_exposer.def( 
                "allocStateComponents"
                , allocStateComponents_function_type( &SE3StateSpace_wrapper::allocStateComponents )
                , ( bp::arg("state") ) );
        ...
        { //::ompl::base::StateSpace::allocStateSampler
            ...
            typedef ::ompl::base::StateSamplerPtr ( SE3StateSpace_wrapper::*default_allocStateSampler_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "allocStateSampler"
                , allocStateSampler_function_type(&::ompl::base::StateSpace::allocStateSampler)
                , default_allocStateSampler_function_type(&SE3StateSpace_wrapper::default_allocStateSampler) );
        ...
        { //::ompl::base::CompoundStateSpace::allocSubspaceStateSampler
            ...
            typedef ::ompl::base::StateSamplerPtr ( SE3StateSpace_wrapper::*default_allocSubspaceStateSampler_function_type)( ::ompl::base::StateSpace const * ) const;
            
            SE3StateSpace_exposer.def( 
                "allocSubspaceStateSampler"
                , allocSubspaceStateSampler_function_type(&::ompl::base::CompoundStateSpace::allocSubspaceStateSampler)
                , default_allocSubspaceStateSampler_function_type(&SE3StateSpace_wrapper::default_allocSubspaceStateSampler)
                , ( bp::arg("subspace") ) );
        ...
        { //::ompl::base::CompoundStateSpace::computeLocations
            ...
            typedef void ( SE3StateSpace_wrapper::*default_computeLocations_function_type)(  ) ;
            
            SE3StateSpace_exposer.def( 
                "computeLocations"
                , computeLocations_function_type(&::ompl::base::CompoundStateSpace::computeLocations)
                , default_computeLocations_function_type(&SE3StateSpace_wrapper::default_computeLocations) );
        ...
        { //::ompl::base::CompoundStateSpace::copyState
            ...
            typedef void ( SE3StateSpace_wrapper::*default_copyState_function_type)( ::ompl::base::State *,::ompl::base::State const * ) const;
            
            SE3StateSpace_exposer.def( 
                "copyState"
                , copyState_function_type(&::ompl::base::CompoundStateSpace::copyState)
                , default_copyState_function_type(&SE3StateSpace_wrapper::default_copyState)
        ...
        { //::ompl::base::CompoundStateSpace::deserialize
            ...
            typedef void ( SE3StateSpace_wrapper::*default_deserialize_function_type)( ::ompl::base::State *,void const * ) const;
            
            SE3StateSpace_exposer.def( 
                "deserialize"
                , deserialize_function_type(&::ompl::base::CompoundStateSpace::deserialize)
                , default_deserialize_function_type(&SE3StateSpace_wrapper::default_deserialize)
        ...
        { //::ompl::base::CompoundStateSpace::distance
            ...
            typedef double ( SE3StateSpace_wrapper::*default_distance_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            SE3StateSpace_exposer.def( 
                "distance"
                , distance_function_type(&::ompl::base::CompoundStateSpace::distance)
                , default_distance_function_type(&SE3StateSpace_wrapper::default_distance)
        ...
        { //::ompl::base::CompoundStateSpace::enforceBounds
            ...
            typedef void ( SE3StateSpace_wrapper::*default_enforceBounds_function_type)( ::ompl::base::State * ) const;
            
            SE3StateSpace_exposer.def( 
                "enforceBounds"
                , enforceBounds_function_type(&::ompl::base::CompoundStateSpace::enforceBounds)
                , default_enforceBounds_function_type(&SE3StateSpace_wrapper::default_enforceBounds)
                , ( bp::arg("state") ) );
        ...
        { //::ompl::base::CompoundStateSpace::equalStates
            ...
            typedef bool ( SE3StateSpace_wrapper::*default_equalStates_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            SE3StateSpace_exposer.def( 
                "equalStates"
                , equalStates_function_type(&::ompl::base::CompoundStateSpace::equalStates)
                , default_equalStates_function_type(&SE3StateSpace_wrapper::default_equalStates)
                , ( bp::arg("state1"), bp::arg("state2") ) );
        ...
        { //::ompl::base::CompoundStateSpace::getDimension
            ...
            typedef unsigned int ( SE3StateSpace_wrapper::*default_getDimension_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "getDimension"
                , getDimension_function_type(&::ompl::base::CompoundStateSpace::getDimension)
                , default_getDimension_function_type(&SE3StateSpace_wrapper::default_getDimension) );
        ...
        { //::ompl::base::StateSpace::getLongestValidSegmentFraction
            ...
            typedef double ( SE3StateSpace_wrapper::*default_getLongestValidSegmentFraction_function_type)(  ) const;
            ...
            SE3StateSpace_exposer.def( 
                ...
                , default_getLongestValidSegmentFraction_function_type(&SE3StateSpace_wrapper::default_getLongestValidSegmentFraction) );
        ...
        { //::ompl::base::CompoundStateSpace::getMaximumExtent
            ...
            typedef double ( SE3StateSpace_wrapper::*default_getMaximumExtent_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "getMaximumExtent"
                , getMaximumExtent_function_type(&::ompl::base::CompoundStateSpace::getMaximumExtent)
                , default_getMaximumExtent_function_type(&SE3StateSpace_wrapper::default_getMaximumExtent) );
        
        }
        { //::ompl::base::CompoundStateSpace::getMeasure
        
            typedef double ( ::ompl::base::CompoundStateSpace::*getMeasure_function_type)(  ) const;
            typedef double ( SE3StateSpace_wrapper::*default_getMeasure_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "getMeasure"
                , getMeasure_function_type(&::ompl::base::CompoundStateSpace::getMeasure)
                , default_getMeasure_function_type(&SE3StateSpace_wrapper::default_getMeasure) );
        ...
        { //::ompl::base::CompoundStateSpace::getSerializationLength
            ...
            typedef unsigned int ( SE3StateSpace_wrapper::*default_getSerializationLength_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "getSerializationLength"
                , getSerializationLength_function_type(&::ompl::base::CompoundStateSpace::getSerializationLength)
                , default_getSerializationLength_function_type(&SE3StateSpace_wrapper::default_getSerializationLength) );
        
        }
        { //::ompl::base::StateSpace::hasSymmetricDistance
        
            typedef bool ( ::ompl::base::StateSpace::*hasSymmetricDistance_function_type)(  ) const;
            typedef bool ( SE3StateSpace_wrapper::*default_hasSymmetricDistance_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "hasSymmetricDistance"
                , hasSymmetricDistance_function_type(&::ompl::base::StateSpace::hasSymmetricDistance)
                , default_hasSymmetricDistance_function_type(&SE3StateSpace_wrapper::default_hasSymmetricDistance) );
        ...
        { //::ompl::base::StateSpace::hasSymmetricInterpolate
            ...
            typedef bool ( SE3StateSpace_wrapper::*default_hasSymmetricInterpolate_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "hasSymmetricInterpolate"
                , hasSymmetricInterpolate_function_type(&::ompl::base::StateSpace::hasSymmetricInterpolate)
                , default_hasSymmetricInterpolate_function_type(&SE3StateSpace_wrapper::default_hasSymmetricInterpolate) );
        ...
        { //::ompl::base::CompoundStateSpace::interpolate
            ...
            typedef void ( SE3StateSpace_wrapper::*default_interpolate_function_type)( ::ompl::base::State const *,::ompl::base::State const *,double const,::ompl::base::State * ) const;
            
            SE3StateSpace_exposer.def( 
                "interpolate"
                , interpolate_function_type(&::ompl::base::CompoundStateSpace::interpolate)
                , default_interpolate_function_type(&SE3StateSpace_wrapper::default_interpolate)
        ...
        { //::ompl::base::CompoundStateSpace::isCompound
            ...
            typedef bool ( SE3StateSpace_wrapper::*default_isCompound_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "isCompound"
                , isCompound_function_type(&::ompl::base::CompoundStateSpace::isCompound)
                , default_isCompound_function_type(&SE3StateSpace_wrapper::default_isCompound) );
        
        }
        { //::ompl::base::StateSpace::isDiscrete
        
            typedef bool ( ::ompl::base::StateSpace::*isDiscrete_function_type)(  ) const;
            typedef bool ( SE3StateSpace_wrapper::*default_isDiscrete_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "isDiscrete"
                , isDiscrete_function_type(&::ompl::base::StateSpace::isDiscrete)
                , default_isDiscrete_function_type(&SE3StateSpace_wrapper::default_isDiscrete) );
        
        }
        { //::ompl::base::CompoundStateSpace::isHybrid
        
            typedef bool ( ::ompl::base::CompoundStateSpace::*isHybrid_function_type)(  ) const;
            typedef bool ( SE3StateSpace_wrapper::*default_isHybrid_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "isHybrid"
                , isHybrid_function_type(&::ompl::base::CompoundStateSpace::isHybrid)
                , default_isHybrid_function_type(&SE3StateSpace_wrapper::default_isHybrid) );
        
        }
        { //::ompl::base::StateSpace::isMetricSpace
        
            typedef bool ( ::ompl::base::StateSpace::*isMetricSpace_function_type)(  ) const;
            typedef bool ( SE3StateSpace_wrapper::*default_isMetricSpace_function_type)(  ) const;
            
            SE3StateSpace_exposer.def( 
                "isMetricSpace"
                , isMetricSpace_function_type(&::ompl::base::StateSpace::isMetricSpace)
                , default_isMetricSpace_function_type(&SE3StateSpace_wrapper::default_isMetricSpace) );
        
        }
        { //::ompl::base::StateSpace::sanityChecks
        
            typedef void ( ::ompl::base::StateSpace::*sanityChecks_function_type)( double,double,unsigned int ) const;
            typedef void ( SE3StateSpace_wrapper::*default_sanityChecks_function_type)( double,double,unsigned int ) const;
            
            SE3StateSpace_exposer.def( 
                "sanityChecks"
                , sanityChecks_function_type(&::ompl::base::StateSpace::sanityChecks)
                , default_sanityChecks_function_type(&SE3StateSpace_wrapper::default_sanityChecks)
        ...
        { //::ompl::base::StateSpace::sanityChecks
            ...
            typedef void ( SE3StateSpace_wrapper::*default_sanityChecks_function_type)(  ) const;
        ...
        { //::ompl::base::CompoundStateSpace::satisfiesBounds
            ...
            typedef bool ( SE3StateSpace_wrapper::*default_satisfiesBounds_function_type)( ::ompl::base::State const * ) const;
            
            SE3StateSpace_exposer.def( 
                "satisfiesBounds"
                , satisfiesBounds_function_type(&::ompl::base::CompoundStateSpace::satisfiesBounds)
                , default_satisfiesBounds_function_type(&SE3StateSpace_wrapper::default_satisfiesBounds)
                , ( bp::arg("state") ) );
        ...
        { //::ompl::base::CompoundStateSpace::serialize
            ...
            typedef void ( SE3StateSpace_wrapper::*default_serialize_function_type)( void *,::ompl::base::State const * ) const;
            
            SE3StateSpace_exposer.def( 
                "serialize"
                , serialize_function_type(&::ompl::base::CompoundStateSpace::serialize)
                , default_serialize_function_type(&SE3StateSpace_wrapper::default_serialize)
        ...
        { //::ompl::base::CompoundStateSpace::setLongestValidSegmentFraction
            ...
            typedef void ( SE3StateSpace_wrapper::*default_setLongestValidSegmentFraction_function_type)( double ) ;
            ...
            SE3StateSpace_exposer.def( 
                ...
                , default_setLongestValidSegmentFraction_function_type(&SE3StateSpace_wrapper::default_setLongestValidSegmentFraction)
        ...
        { //::ompl::base::CompoundStateSpace::setup
            ...
            typedef void ( SE3StateSpace_wrapper::*default_setup_function_type)(  ) ;
            
            SE3StateSpace_exposer.def( 
                "setup"
                , setup_function_type(&::ompl::base::CompoundStateSpace::setup)
                , default_setup_function_type(&SE3StateSpace_wrapper::default_setup) );
        ...
        { //::ompl::base::CompoundStateSpace::validSegmentCount
            ...
            typedef unsigned int ( SE3StateSpace_wrapper::*default_validSegmentCount_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            SE3StateSpace_exposer.def( 
                "validSegmentCount"
                , validSegmentCount_function_type(&::ompl::base::CompoundStateSpace::validSegmentCount)
                , default_validSegmentCount_function_type(&SE3StateSpace_wrapper::default_validSegmentCount)
                , ( bp::arg("state1"), bp::arg("state2") ) );
