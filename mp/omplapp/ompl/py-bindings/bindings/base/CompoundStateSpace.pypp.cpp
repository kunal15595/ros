...
#include "CompoundStateSpace.pypp.hpp"

namespace bp = boost::python;

struct CompoundStateSpace_wrapper : ompl::base::CompoundStateSpace, bp::wrapper< ompl::base::CompoundStateSpace > {

    CompoundStateSpace_wrapper( )
    : ompl::base::CompoundStateSpace( )
      , bp::wrapper< ompl::base::CompoundStateSpace >(){
        // null constructor
    
    }

    CompoundStateSpace_wrapper(::std::vector< boost::shared_ptr<ompl::base::StateSpace> > const & components, ::std::vector< double > const & weights )
    : ompl::base::CompoundStateSpace( boost::ref(components), boost::ref(weights) )
      , bp::wrapper< ompl::base::CompoundStateSpace >(){
        // constructor
    ...
    virtual ::ompl::base::State * allocState(  ) const  {
        if( bp::override func_allocState = this->get_override( "allocState" ) )
            ...
            return this->ompl::base::CompoundStateSpace::allocState(  );
        }
    }
    
    ::ompl::base::State * default_allocState(  ) const  {
        return ompl::base::CompoundStateSpace::allocState( );
    }
    ...
    virtual double distance( ::ompl::base::State const * state1, ::ompl::base::State const * state2 ) const  {
        if( bp::override func_distance = this->get_override( "distance" ) )
            ...
            return this->ompl::base::CompoundStateSpace::distance( boost::python::ptr(state1), boost::python::ptr(state2) );
        }
    }
    
    double default_distance( ::ompl::base::State const * state1, ::ompl::base::State const * state2 ) const  {
        return ompl::base::CompoundStateSpace::distance( boost::python::ptr(state1), boost::python::ptr(state2) );
    }
    ...
    virtual void freeState( ::ompl::base::State * state ) const  {
        if( bp::override func_freeState = this->get_override( "freeState" ) )
            ...
            this->ompl::base::CompoundStateSpace::freeState( boost::python::ptr(state) );
        }
    }
    
    void default_freeState( ::ompl::base::State * state ) const  {
        ompl::base::CompoundStateSpace::freeState( boost::python::ptr(state) );
    }
    ...
    virtual void interpolate( ::ompl::base::State const * from, ::ompl::base::State const * to, double const t, ::ompl::base::State * state ) const  {
        if( bp::override func_interpolate = this->get_override( "interpolate" ) )
            ...
            this->ompl::base::CompoundStateSpace::interpolate( boost::python::ptr(from), boost::python::ptr(to), t, boost::python::ptr(state) );
        }
    }
    
    void default_interpolate( ::ompl::base::State const * from, ::ompl::base::State const * to, double const t, ::ompl::base::State * state ) const  {
        ompl::base::CompoundStateSpace::interpolate( boost::python::ptr(from), boost::python::ptr(to), t, boost::python::ptr(state) );
    }
...
std::string __printSettings(::ompl::base::CompoundStateSpace* obj)
{
    std::ostringstream s;
    obj->printSettings(s);
    return s.str();
...
std::string __printState(::ompl::base::CompoundStateSpace* space, ompl::base::State* state)
        {
            std::ostringstream s;
...
void register_CompoundStateSpace_class(){
    ...
    { //::ompl::base::CompoundStateSpace
        typedef bp::class_< CompoundStateSpace_wrapper, bp::bases< ompl::base::StateSpace >, boost::noncopyable > CompoundStateSpace_exposer_t;
        CompoundStateSpace_exposer_t CompoundStateSpace_exposer = CompoundStateSpace_exposer_t( "CompoundStateSpace", bp::init< >() );
        bp::scope CompoundStateSpace_scope( CompoundStateSpace_exposer );
        CompoundStateSpace_exposer.def( bp::init< std::vector< boost::shared_ptr<ompl::base::StateSpace> > const &, std::vector< double > const & >(( bp::arg("components"), bp::arg("weights") )) );
        { //::ompl::base::CompoundStateSpace::addSubspace
        
            typedef void ( ::ompl::base::CompoundStateSpace::*addSubspace_function_type)( ::ompl::base::StateSpacePtr const &,double ) ;
            
            CompoundStateSpace_exposer.def( 
                "addSubspace"
                , addSubspace_function_type( &::ompl::base::CompoundStateSpace::addSubspace )
                , ( bp::arg("component"), bp::arg("weight") ) );
        ...
        { //::ompl::base::CompoundStateSpace::allocDefaultStateSampler
            ...
            typedef ::ompl::base::StateSamplerPtr ( CompoundStateSpace_wrapper::*default_allocDefaultStateSampler_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "allocDefaultStateSampler"
                , allocDefaultStateSampler_function_type(&::ompl::base::CompoundStateSpace::allocDefaultStateSampler)
                , default_allocDefaultStateSampler_function_type(&CompoundStateSpace_wrapper::default_allocDefaultStateSampler) );
        
        }
        { //::ompl::base::CompoundStateSpace::allocState
        
            typedef ::ompl::base::State * ( ::ompl::base::CompoundStateSpace::*allocState_function_type)(  ) const;
            typedef ::ompl::base::State * ( CompoundStateSpace_wrapper::*default_allocState_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "allocState"
                , allocState_function_type(&::ompl::base::CompoundStateSpace::allocState)
                , default_allocState_function_type(&CompoundStateSpace_wrapper::default_allocState)
                , bp::return_value_policy< bp::reference_existing_object >() );
        
        }
        { //::ompl::base::CompoundStateSpace::allocStateComponents
        
            typedef void ( CompoundStateSpace_wrapper::*allocStateComponents_function_type)( ::ompl::base::CompoundState * ) const;
            
            CompoundStateSpace_exposer.def( 
                "allocStateComponents"
                , allocStateComponents_function_type( &CompoundStateSpace_wrapper::allocStateComponents )
                , ( bp::arg("state") ) );
        ...
        { //::ompl::base::CompoundStateSpace::allocSubspaceStateSampler
            ...
            typedef ::ompl::base::StateSamplerPtr ( CompoundStateSpace_wrapper::*default_allocSubspaceStateSampler_function_type)( ::ompl::base::StateSpace const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "allocSubspaceStateSampler"
                , allocSubspaceStateSampler_function_type(&::ompl::base::CompoundStateSpace::allocSubspaceStateSampler)
                , default_allocSubspaceStateSampler_function_type(&CompoundStateSpace_wrapper::default_allocSubspaceStateSampler)
                , ( bp::arg("subspace") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::as
        
            typedef ::ompl::base::RealVectorStateSpace * ( ::ompl::base::CompoundStateSpace::*as_function_type)( unsigned int const ) const;
            
            CompoundStateSpace_exposer.def( 
                "as"
                , as_function_type( &::ompl::base::CompoundStateSpace::as )
                , ( bp::arg("index") )
                , bp::return_value_policy< bp::reference_existing_object >() );
        ...
        { //::ompl::base::CompoundStateSpace::as
            ...
            typedef ::ompl::base::RealVectorStateSpace * ( ::ompl::base::CompoundStateSpace::*as_function_type)( ::std::string const & ) const;
        ...
        { //::ompl::base::CompoundStateSpace::computeLocations
            ...
            typedef void ( CompoundStateSpace_wrapper::*default_computeLocations_function_type)(  ) ;
            
            CompoundStateSpace_exposer.def( 
                "computeLocations"
                , computeLocations_function_type(&::ompl::base::CompoundStateSpace::computeLocations)
                , default_computeLocations_function_type(&CompoundStateSpace_wrapper::default_computeLocations) );
        ...
        { //::ompl::base::CompoundStateSpace::copyState
            ...
            typedef void ( CompoundStateSpace_wrapper::*default_copyState_function_type)( ::ompl::base::State *,::ompl::base::State const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "copyState"
                , copyState_function_type(&::ompl::base::CompoundStateSpace::copyState)
                , default_copyState_function_type(&CompoundStateSpace_wrapper::default_copyState)
        ...
        { //::ompl::base::CompoundStateSpace::deserialize
            ...
            typedef void ( CompoundStateSpace_wrapper::*default_deserialize_function_type)( ::ompl::base::State *,void const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "deserialize"
                , deserialize_function_type(&::ompl::base::CompoundStateSpace::deserialize)
                , default_deserialize_function_type(&CompoundStateSpace_wrapper::default_deserialize)
                , ( bp::arg("state"), bp::arg("serialization") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::distance
        
            typedef double ( ::ompl::base::CompoundStateSpace::*distance_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            typedef double ( CompoundStateSpace_wrapper::*default_distance_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "distance"
                , distance_function_type(&::ompl::base::CompoundStateSpace::distance)
                , default_distance_function_type(&CompoundStateSpace_wrapper::default_distance)
        ...
        { //::ompl::base::CompoundStateSpace::enforceBounds
            ...
            typedef void ( CompoundStateSpace_wrapper::*default_enforceBounds_function_type)( ::ompl::base::State * ) const;
            
            CompoundStateSpace_exposer.def( 
                "enforceBounds"
                , enforceBounds_function_type(&::ompl::base::CompoundStateSpace::enforceBounds)
                , default_enforceBounds_function_type(&CompoundStateSpace_wrapper::default_enforceBounds)
                , ( bp::arg("state") ) );
        ...
        { //::ompl::base::CompoundStateSpace::equalStates
            ...
            typedef bool ( CompoundStateSpace_wrapper::*default_equalStates_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "equalStates"
                , equalStates_function_type(&::ompl::base::CompoundStateSpace::equalStates)
                , default_equalStates_function_type(&CompoundStateSpace_wrapper::default_equalStates)
                , ( bp::arg("state1"), bp::arg("state2") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::freeState
        
            typedef void ( ::ompl::base::CompoundStateSpace::*freeState_function_type)( ::ompl::base::State * ) const;
            typedef void ( CompoundStateSpace_wrapper::*default_freeState_function_type)( ::ompl::base::State * ) const;
            
            CompoundStateSpace_exposer.def( 
                "freeState"
                , freeState_function_type(&::ompl::base::CompoundStateSpace::freeState)
                , default_freeState_function_type(&CompoundStateSpace_wrapper::default_freeState)
                , ( bp::arg("state") ) );
        ...
        { //::ompl::base::CompoundStateSpace::getDimension
            ...
            typedef unsigned int ( CompoundStateSpace_wrapper::*default_getDimension_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "getDimension"
                , getDimension_function_type(&::ompl::base::CompoundStateSpace::getDimension)
                , default_getDimension_function_type(&CompoundStateSpace_wrapper::default_getDimension) );
        ...
        { //::ompl::base::CompoundStateSpace::getMaximumExtent
            ...
            typedef double ( CompoundStateSpace_wrapper::*default_getMaximumExtent_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "getMaximumExtent"
                , getMaximumExtent_function_type(&::ompl::base::CompoundStateSpace::getMaximumExtent)
                , default_getMaximumExtent_function_type(&CompoundStateSpace_wrapper::default_getMaximumExtent) );
        
        }
        { //::ompl::base::CompoundStateSpace::getMeasure
        
            typedef double ( ::ompl::base::CompoundStateSpace::*getMeasure_function_type)(  ) const;
            typedef double ( CompoundStateSpace_wrapper::*default_getMeasure_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "getMeasure"
                , getMeasure_function_type(&::ompl::base::CompoundStateSpace::getMeasure)
                , default_getMeasure_function_type(&CompoundStateSpace_wrapper::default_getMeasure) );
        ...
        { //::ompl::base::CompoundStateSpace::getSerializationLength
            ...
            typedef unsigned int ( CompoundStateSpace_wrapper::*default_getSerializationLength_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "getSerializationLength"
                , getSerializationLength_function_type(&::ompl::base::CompoundStateSpace::getSerializationLength)
                , default_getSerializationLength_function_type(&CompoundStateSpace_wrapper::default_getSerializationLength) );
        
        }
        { //::ompl::base::CompoundStateSpace::getSubspace
        
            typedef ::ompl::base::StateSpacePtr const & ( ::ompl::base::CompoundStateSpace::*getSubspace_function_type)( unsigned int const ) const;
            
            CompoundStateSpace_exposer.def( 
                "getSubspace"
                , getSubspace_function_type( &::ompl::base::CompoundStateSpace::getSubspace )
                , ( bp::arg("index") )
        ...
        { //::ompl::base::CompoundStateSpace::getSubspace
            ...
            typedef ::ompl::base::StateSpacePtr const & ( ::ompl::base::CompoundStateSpace::*getSubspace_function_type)( ::std::string const & ) const;
        ...
        { //::ompl::base::CompoundStateSpace::getSubspaceCount
        
            typedef unsigned int ( ::ompl::base::CompoundStateSpace::*getSubspaceCount_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "getSubspaceCount"
                , getSubspaceCount_function_type( &::ompl::base::CompoundStateSpace::getSubspaceCount ) );
        
        }
        { //::ompl::base::CompoundStateSpace::getSubspaceIndex
        
            typedef unsigned int ( ::ompl::base::CompoundStateSpace::*getSubspaceIndex_function_type)( ::std::string const & ) const;
            
            CompoundStateSpace_exposer.def( 
                "getSubspaceIndex"
                , getSubspaceIndex_function_type( &::ompl::base::CompoundStateSpace::getSubspaceIndex )
                , ( bp::arg("name") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::getSubspaceWeight
        
            typedef double ( ::ompl::base::CompoundStateSpace::*getSubspaceWeight_function_type)( unsigned int const ) const;
            
            CompoundStateSpace_exposer.def( 
                "getSubspaceWeight"
                , getSubspaceWeight_function_type( &::ompl::base::CompoundStateSpace::getSubspaceWeight )
                , ( bp::arg("index") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::getSubspaceWeight
        
            typedef double ( ::ompl::base::CompoundStateSpace::*getSubspaceWeight_function_type)( ::std::string const & ) const;
        ...
        { //::ompl::base::CompoundStateSpace::getSubspaceWeights
        
            typedef ::std::vector< double > const & ( ::ompl::base::CompoundStateSpace::*getSubspaceWeights_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "getSubspaceWeights"
                , getSubspaceWeights_function_type( &::ompl::base::CompoundStateSpace::getSubspaceWeights )
                , bp::return_value_policy< bp::copy_const_reference >() );
        
        }
        { //::ompl::base::CompoundStateSpace::getSubspaces
        
            typedef ::std::vector< boost::shared_ptr<ompl::base::StateSpace> > const & ( ::ompl::base::CompoundStateSpace::*getSubspaces_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "getSubspaces"
                , getSubspaces_function_type( &::ompl::base::CompoundStateSpace::getSubspaces )
                , bp::return_value_policy< bp::copy_const_reference >() );
        
        }
        { //::ompl::base::CompoundStateSpace::hasSubspace
        
            typedef bool ( ::ompl::base::CompoundStateSpace::*hasSubspace_function_type)( ::std::string const & ) const;
            
            CompoundStateSpace_exposer.def( 
                "hasSubspace"
                , hasSubspace_function_type( &::ompl::base::CompoundStateSpace::hasSubspace )
                , ( bp::arg("name") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::interpolate
        
            typedef void ( ::ompl::base::CompoundStateSpace::*interpolate_function_type)( ::ompl::base::State const *,::ompl::base::State const *,double const,::ompl::base::State * ) const;
            typedef void ( CompoundStateSpace_wrapper::*default_interpolate_function_type)( ::ompl::base::State const *,::ompl::base::State const *,double const,::ompl::base::State * ) const;
            
            CompoundStateSpace_exposer.def( 
                "interpolate"
                , interpolate_function_type(&::ompl::base::CompoundStateSpace::interpolate)
                , default_interpolate_function_type(&CompoundStateSpace_wrapper::default_interpolate)
        ...
        { //::ompl::base::CompoundStateSpace::isCompound
            ...
            typedef bool ( CompoundStateSpace_wrapper::*default_isCompound_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "isCompound"
                , isCompound_function_type(&::ompl::base::CompoundStateSpace::isCompound)
                , default_isCompound_function_type(&CompoundStateSpace_wrapper::default_isCompound) );
        
        }
        { //::ompl::base::CompoundStateSpace::isHybrid
        
            typedef bool ( ::ompl::base::CompoundStateSpace::*isHybrid_function_type)(  ) const;
            typedef bool ( CompoundStateSpace_wrapper::*default_isHybrid_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "isHybrid"
                , isHybrid_function_type(&::ompl::base::CompoundStateSpace::isHybrid)
                , default_isHybrid_function_type(&CompoundStateSpace_wrapper::default_isHybrid) );
        
        }
        { //::ompl::base::CompoundStateSpace::isLocked
        
            typedef bool ( ::ompl::base::CompoundStateSpace::*isLocked_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "isLocked"
                , isLocked_function_type( &::ompl::base::CompoundStateSpace::isLocked ) );
        
        }
        { //::ompl::base::CompoundStateSpace::lock
        
            typedef void ( ::ompl::base::CompoundStateSpace::*lock_function_type)(  ) ;
            
            CompoundStateSpace_exposer.def( 
                "lock"
                , lock_function_type( &::ompl::base::CompoundStateSpace::lock ) );
        ...
        { //::ompl::base::CompoundStateSpace::satisfiesBounds
            ...
            typedef bool ( CompoundStateSpace_wrapper::*default_satisfiesBounds_function_type)( ::ompl::base::State const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "satisfiesBounds"
                , satisfiesBounds_function_type(&::ompl::base::CompoundStateSpace::satisfiesBounds)
                , default_satisfiesBounds_function_type(&CompoundStateSpace_wrapper::default_satisfiesBounds)
                , ( bp::arg("state") ) );
        ...
        { //::ompl::base::CompoundStateSpace::serialize
            ...
            typedef void ( CompoundStateSpace_wrapper::*default_serialize_function_type)( void *,::ompl::base::State const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "serialize"
                , serialize_function_type(&::ompl::base::CompoundStateSpace::serialize)
                , default_serialize_function_type(&CompoundStateSpace_wrapper::default_serialize)
        ...
        { //::ompl::base::CompoundStateSpace::setLongestValidSegmentFraction
            ...
            typedef void ( CompoundStateSpace_wrapper::*default_setLongestValidSegmentFraction_function_type)( double ) ;
            ...
            CompoundStateSpace_exposer.def( 
                ...
                , default_setLongestValidSegmentFraction_function_type(&CompoundStateSpace_wrapper::default_setLongestValidSegmentFraction)
                , ( bp::arg("segmentFraction") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::setSubspaceWeight
        
            typedef void ( ::ompl::base::CompoundStateSpace::*setSubspaceWeight_function_type)( unsigned int const,double ) ;
            
            CompoundStateSpace_exposer.def( 
                "setSubspaceWeight"
                , setSubspaceWeight_function_type( &::ompl::base::CompoundStateSpace::setSubspaceWeight )
                , ( bp::arg("index"), bp::arg("weight") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::setSubspaceWeight
        
            typedef void ( ::ompl::base::CompoundStateSpace::*setSubspaceWeight_function_type)( ::std::string const &,double ) ;
            
            CompoundStateSpace_exposer.def( 
                "setSubspaceWeight"
                , setSubspaceWeight_function_type( &::ompl::base::CompoundStateSpace::setSubspaceWeight )
                , ( bp::arg("name"), bp::arg("weight") ) );
        
        }
        { //::ompl::base::CompoundStateSpace::setup
        
            typedef void ( ::ompl::base::CompoundStateSpace::*setup_function_type)(  ) ;
            typedef void ( CompoundStateSpace_wrapper::*default_setup_function_type)(  ) ;
            
            CompoundStateSpace_exposer.def( 
                "setup"
                , setup_function_type(&::ompl::base::CompoundStateSpace::setup)
                , default_setup_function_type(&CompoundStateSpace_wrapper::default_setup) );
        ...
        { //::ompl::base::CompoundStateSpace::validSegmentCount
            ...
            typedef unsigned int ( CompoundStateSpace_wrapper::*default_validSegmentCount_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            CompoundStateSpace_exposer.def( 
                "validSegmentCount"
                , validSegmentCount_function_type(&::ompl::base::CompoundStateSpace::validSegmentCount)
                , default_validSegmentCount_function_type(&CompoundStateSpace_wrapper::default_validSegmentCount)
                , ( bp::arg("state1"), bp::arg("state2") ) );
        ...
        { //::ompl::base::StateSpace::allocStateSampler
            ...
            typedef ::ompl::base::StateSamplerPtr ( CompoundStateSpace_wrapper::*default_allocStateSampler_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "allocStateSampler"
                , allocStateSampler_function_type(&::ompl::base::StateSpace::allocStateSampler)
                , default_allocStateSampler_function_type(&CompoundStateSpace_wrapper::default_allocStateSampler) );
        ...
        { //::ompl::base::StateSpace::getLongestValidSegmentFraction
            ...
            typedef double ( CompoundStateSpace_wrapper::*default_getLongestValidSegmentFraction_function_type)(  ) const;
            ...
            CompoundStateSpace_exposer.def( 
                ...
                , default_getLongestValidSegmentFraction_function_type(&CompoundStateSpace_wrapper::default_getLongestValidSegmentFraction) );
        
        }
        { //::ompl::base::StateSpace::hasSymmetricDistance
        
            typedef bool ( ::ompl::base::StateSpace::*hasSymmetricDistance_function_type)(  ) const;
            typedef bool ( CompoundStateSpace_wrapper::*default_hasSymmetricDistance_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "hasSymmetricDistance"
                , hasSymmetricDistance_function_type(&::ompl::base::StateSpace::hasSymmetricDistance)
                , default_hasSymmetricDistance_function_type(&CompoundStateSpace_wrapper::default_hasSymmetricDistance) );
        ...
        { //::ompl::base::StateSpace::hasSymmetricInterpolate
            ...
            typedef bool ( CompoundStateSpace_wrapper::*default_hasSymmetricInterpolate_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "hasSymmetricInterpolate"
                , hasSymmetricInterpolate_function_type(&::ompl::base::StateSpace::hasSymmetricInterpolate)
                , default_hasSymmetricInterpolate_function_type(&CompoundStateSpace_wrapper::default_hasSymmetricInterpolate) );
        
        }
        { //::ompl::base::StateSpace::isDiscrete
        
            typedef bool ( ::ompl::base::StateSpace::*isDiscrete_function_type)(  ) const;
            typedef bool ( CompoundStateSpace_wrapper::*default_isDiscrete_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "isDiscrete"
                , isDiscrete_function_type(&::ompl::base::StateSpace::isDiscrete)
                , default_isDiscrete_function_type(&CompoundStateSpace_wrapper::default_isDiscrete) );
        
        }
        { //::ompl::base::StateSpace::isMetricSpace
        
            typedef bool ( ::ompl::base::StateSpace::*isMetricSpace_function_type)(  ) const;
            typedef bool ( CompoundStateSpace_wrapper::*default_isMetricSpace_function_type)(  ) const;
            
            CompoundStateSpace_exposer.def( 
                "isMetricSpace"
                , isMetricSpace_function_type(&::ompl::base::StateSpace::isMetricSpace)
                , default_isMetricSpace_function_type(&CompoundStateSpace_wrapper::default_isMetricSpace) );
        
        }
        { //::ompl::base::StateSpace::registerProjections
        
            typedef void ( ::ompl::base::StateSpace::*registerProjections_function_type)(  ) ;
            typedef void ( CompoundStateSpace_wrapper::*default_registerProjections_function_type)(  ) ;
            
            CompoundStateSpace_exposer.def( 
                "registerProjections"
                , registerProjections_function_type(&::ompl::base::StateSpace::registerProjections)
                , default_registerProjections_function_type(&CompoundStateSpace_wrapper::default_registerProjections) );
        
        }
        { //::ompl::base::StateSpace::sanityChecks
        
            typedef void ( ::ompl::base::StateSpace::*sanityChecks_function_type)( double,double,unsigned int ) const;
            typedef void ( CompoundStateSpace_wrapper::*default_sanityChecks_function_type)( double,double,unsigned int ) const;
            
            CompoundStateSpace_exposer.def( 
                "sanityChecks"
                , sanityChecks_function_type(&::ompl::base::StateSpace::sanityChecks)
                , default_sanityChecks_function_type(&CompoundStateSpace_wrapper::default_sanityChecks)
        ...
        { //::ompl::base::StateSpace::sanityChecks
            ...
            typedef void ( CompoundStateSpace_wrapper::*default_sanityChecks_function_type)(  ) const;
        ...
        CompoundStateSpace_exposer.def("settings", &__printSettings);
        CompoundStateSpace_exposer.def("string", &__printState);
    }
