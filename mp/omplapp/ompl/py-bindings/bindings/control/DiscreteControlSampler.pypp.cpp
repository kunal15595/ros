...
#include "DiscreteControlSampler.pypp.hpp"

namespace bp = boost::python;

struct DiscreteControlSampler_wrapper : ompl::control::DiscreteControlSampler, bp::wrapper< ompl::control::DiscreteControlSampler > {

    DiscreteControlSampler_wrapper(::ompl::control::ControlSpace const * space )
    : ompl::control::DiscreteControlSampler( boost::python::ptr(space) )
      , bp::wrapper< ompl::control::DiscreteControlSampler >(){
        // constructor
    ...
    virtual void sample( ::ompl::control::Control * control ) {
        if( bp::override func_sample = this->get_override( "sample" ) )
            ...
            this->ompl::control::DiscreteControlSampler::sample( boost::python::ptr(control) );
        }
    }
    
    void default_sample( ::ompl::control::Control * control ) {
        ompl::control::DiscreteControlSampler::sample( boost::python::ptr(control) );
    }
...
void register_DiscreteControlSampler_class(){
    ...
    { //::ompl::control::DiscreteControlSampler
        typedef bp::class_< DiscreteControlSampler_wrapper, bp::bases< ompl::control::ControlSampler >, boost::noncopyable > DiscreteControlSampler_exposer_t;
        DiscreteControlSampler_exposer_t DiscreteControlSampler_exposer = DiscreteControlSampler_exposer_t( "DiscreteControlSampler", bp::init< ompl::control::ControlSpace const * >(( bp::arg("space") )) );
        bp::scope DiscreteControlSampler_scope( DiscreteControlSampler_exposer );
        bp::implicitly_convertible< ompl::control::ControlSpace const *, ompl::control::DiscreteControlSampler >();
        { //::ompl::control::DiscreteControlSampler::sample
        
            typedef void ( ::ompl::control::DiscreteControlSampler::*sample_function_type)( ::ompl::control::Control * ) ;
            typedef void ( DiscreteControlSampler_wrapper::*default_sample_function_type)( ::ompl::control::Control * ) ;
            
            DiscreteControlSampler_exposer.def( 
                "sample"
                , sample_function_type(&::ompl::control::DiscreteControlSampler::sample)
                , default_sample_function_type(&DiscreteControlSampler_wrapper::default_sample)
                , ( bp::arg("control") ) );
        ...
        { //::ompl::control::ControlSampler::sample
            ...
            typedef void ( DiscreteControlSampler_wrapper::*default_sample_function_type)( ::ompl::control::Control *,::ompl::base::State const * ) ;
        ...
        { //::ompl::control::ControlSampler::sampleNext
            ...
            typedef void ( DiscreteControlSampler_wrapper::*default_sampleNext_function_type)( ::ompl::control::Control *,::ompl::control::Control const * ) ;
            
            DiscreteControlSampler_exposer.def( 
                "sampleNext"
                , sampleNext_function_type(&::ompl::control::ControlSampler::sampleNext)
                , default_sampleNext_function_type(&DiscreteControlSampler_wrapper::default_sampleNext)
        ...
        { //::ompl::control::ControlSampler::sampleNext
            ...
            typedef void ( DiscreteControlSampler_wrapper::*default_sampleNext_function_type)( ::ompl::control::Control *,::ompl::control::Control const *,::ompl::base::State const * ) ;
        ...
        { //::ompl::control::ControlSampler::sampleStepCount
            ...
            typedef unsigned int ( DiscreteControlSampler_wrapper::*default_sampleStepCount_function_type)( unsigned int,unsigned int ) ;
            
            DiscreteControlSampler_exposer.def( 
                "sampleStepCount"
                , sampleStepCount_function_type(&::ompl::control::ControlSampler::sampleStepCount)
                , default_sampleStepCount_function_type(&DiscreteControlSampler_wrapper::default_sampleStepCount)
