...
#include "PathLengthOptimizationObjective.pypp.hpp"

namespace bp = boost::python;

struct PathLengthOptimizationObjective_wrapper : ompl::base::PathLengthOptimizationObjective, bp::wrapper< ompl::base::PathLengthOptimizationObjective > {

    PathLengthOptimizationObjective_wrapper(::ompl::base::SpaceInformationPtr const & si )
    : ompl::base::PathLengthOptimizationObjective( si )
      , bp::wrapper< ompl::base::PathLengthOptimizationObjective >(){
        // constructor
    ...
    virtual ::ompl::base::Cost motionCost( ::ompl::base::State const * s1, ::ompl::base::State const * s2 ) const  {
        if( bp::override func_motionCost = this->get_override( "motionCost" ) )
            ...
            return this->ompl::base::PathLengthOptimizationObjective::motionCost( boost::python::ptr(s1), boost::python::ptr(s2) );
        }
    }
    
    ::ompl::base::Cost default_motionCost( ::ompl::base::State const * s1, ::ompl::base::State const * s2 ) const  {
        return ompl::base::PathLengthOptimizationObjective::motionCost( boost::python::ptr(s1), boost::python::ptr(s2) );
    }
    ...
    virtual ::ompl::base::Cost motionCostHeuristic( ::ompl::base::State const * s1, ::ompl::base::State const * s2 ) const  {
        if( bp::override func_motionCostHeuristic = this->get_override( "motionCostHeuristic" ) )
            ...
            return this->ompl::base::PathLengthOptimizationObjective::motionCostHeuristic( boost::python::ptr(s1), boost::python::ptr(s2) );
        }
    }
    
    ::ompl::base::Cost default_motionCostHeuristic( ::ompl::base::State const * s1, ::ompl::base::State const * s2 ) const  {
        return ompl::base::PathLengthOptimizationObjective::motionCostHeuristic( boost::python::ptr(s1), boost::python::ptr(s2) );
    }
...
void register_PathLengthOptimizationObjective_class(){
    ...
    { //::ompl::base::PathLengthOptimizationObjective
        typedef bp::class_< PathLengthOptimizationObjective_wrapper, bp::bases< ompl::base::OptimizationObjective >, boost::noncopyable > PathLengthOptimizationObjective_exposer_t;
        PathLengthOptimizationObjective_exposer_t PathLengthOptimizationObjective_exposer = PathLengthOptimizationObjective_exposer_t( "PathLengthOptimizationObjective", bp::init< ompl::base::SpaceInformationPtr const & >(( bp::arg("si") )) );
        bp::scope PathLengthOptimizationObjective_scope( PathLengthOptimizationObjective_exposer );
        bp::implicitly_convertible< ompl::base::SpaceInformationPtr const &, ompl::base::PathLengthOptimizationObjective >();
        { //::ompl::base::PathLengthOptimizationObjective::motionCost
        
            typedef ::ompl::base::Cost ( ::ompl::base::PathLengthOptimizationObjective::*motionCost_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_motionCost_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "motionCost"
                , motionCost_function_type(&::ompl::base::PathLengthOptimizationObjective::motionCost)
                , default_motionCost_function_type(&PathLengthOptimizationObjective_wrapper::default_motionCost)
                , ( bp::arg("s1"), bp::arg("s2") ) );
        
        }
        { //::ompl::base::PathLengthOptimizationObjective::motionCostHeuristic
        
            typedef ::ompl::base::Cost ( ::ompl::base::PathLengthOptimizationObjective::*motionCostHeuristic_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_motionCostHeuristic_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "motionCostHeuristic"
                , motionCostHeuristic_function_type(&::ompl::base::PathLengthOptimizationObjective::motionCostHeuristic)
                , default_motionCostHeuristic_function_type(&PathLengthOptimizationObjective_wrapper::default_motionCostHeuristic)
                , ( bp::arg("s1"), bp::arg("s2") ) );
        ...
        { //::ompl::base::OptimizationObjective::averageStateCost
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_averageStateCost_function_type)( unsigned int ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "averageStateCost"
                , averageStateCost_function_type(&::ompl::base::OptimizationObjective::averageStateCost)
                , default_averageStateCost_function_type(&PathLengthOptimizationObjective_wrapper::default_averageStateCost)
                , ( bp::arg("numStates") ) );
        ...
        { //::ompl::base::OptimizationObjective::combineCosts
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_combineCosts_function_type)( ::ompl::base::Cost,::ompl::base::Cost ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "combineCosts"
                , combineCosts_function_type(&::ompl::base::OptimizationObjective::combineCosts)
                , default_combineCosts_function_type(&PathLengthOptimizationObjective_wrapper::default_combineCosts)
                , ( bp::arg("c1"), bp::arg("c2") ) );
        ...
        { //::ompl::base::OptimizationObjective::getCost
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_getCost_function_type)( ::ompl::base::Path const & ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "getCost"
                , getCost_function_type(&::ompl::base::OptimizationObjective::getCost)
                , default_getCost_function_type(&PathLengthOptimizationObjective_wrapper::default_getCost)
                , ( bp::arg("path") ) );
        ...
        { //::ompl::base::OptimizationObjective::identityCost
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_identityCost_function_type)(  ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "identityCost"
                , identityCost_function_type(&::ompl::base::OptimizationObjective::identityCost)
                , default_identityCost_function_type(&PathLengthOptimizationObjective_wrapper::default_identityCost) );
        ...
        { //::ompl::base::OptimizationObjective::infiniteCost
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_infiniteCost_function_type)(  ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "infiniteCost"
                , infiniteCost_function_type(&::ompl::base::OptimizationObjective::infiniteCost)
                , default_infiniteCost_function_type(&PathLengthOptimizationObjective_wrapper::default_infiniteCost) );
        ...
        { //::ompl::base::OptimizationObjective::initialCost
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_initialCost_function_type)( ::ompl::base::State const * ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "initialCost"
                , initialCost_function_type(&::ompl::base::OptimizationObjective::initialCost)
                , default_initialCost_function_type(&PathLengthOptimizationObjective_wrapper::default_initialCost)
                , ( bp::arg("s") ) );
        ...
        { //::ompl::base::OptimizationObjective::isCostBetterThan
            ...
            typedef bool ( PathLengthOptimizationObjective_wrapper::*default_isCostBetterThan_function_type)( ::ompl::base::Cost,::ompl::base::Cost ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "isCostBetterThan"
                , isCostBetterThan_function_type(&::ompl::base::OptimizationObjective::isCostBetterThan)
                , default_isCostBetterThan_function_type(&PathLengthOptimizationObjective_wrapper::default_isCostBetterThan)
                , ( bp::arg("c1"), bp::arg("c2") ) );
        ...
        { //::ompl::base::OptimizationObjective::isSatisfied
            ...
            typedef bool ( PathLengthOptimizationObjective_wrapper::*default_isSatisfied_function_type)( ::ompl::base::Cost ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "isSatisfied"
                , isSatisfied_function_type(&::ompl::base::OptimizationObjective::isSatisfied)
                , default_isSatisfied_function_type(&PathLengthOptimizationObjective_wrapper::default_isSatisfied)
                , ( bp::arg("c") ) );
        ...
        { //::ompl::base::OptimizationObjective::isSymmetric
            ...
            typedef bool ( PathLengthOptimizationObjective_wrapper::*default_isSymmetric_function_type)(  ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "isSymmetric"
                , isSymmetric_function_type(&::ompl::base::OptimizationObjective::isSymmetric)
                , default_isSymmetric_function_type(&PathLengthOptimizationObjective_wrapper::default_isSymmetric) );
        ...
        { //::ompl::base::OptimizationObjective::stateCost
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_stateCost_function_type)( ::ompl::base::State const * ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "stateCost"
                , stateCost_function_type(&::ompl::base::OptimizationObjective::stateCost)
                , default_stateCost_function_type(&PathLengthOptimizationObjective_wrapper::default_stateCost)
                , ( bp::arg("s") ) );
        ...
        { //::ompl::base::OptimizationObjective::terminalCost
            ...
            typedef ::ompl::base::Cost ( PathLengthOptimizationObjective_wrapper::*default_terminalCost_function_type)( ::ompl::base::State const * ) const;
            
            PathLengthOptimizationObjective_exposer.def( 
                "terminalCost"
                , terminalCost_function_type(&::ompl::base::OptimizationObjective::terminalCost)
                , default_terminalCost_function_type(&PathLengthOptimizationObjective_wrapper::default_terminalCost)
                , ( bp::arg("s") ) );
