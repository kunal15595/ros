...
#include "MinimaxObjective.pypp.hpp"

namespace bp = boost::python;

struct MinimaxObjective_wrapper : ompl::base::MinimaxObjective, bp::wrapper< ompl::base::MinimaxObjective > {

    MinimaxObjective_wrapper(::ompl::base::SpaceInformationPtr const & si )
    : ompl::base::MinimaxObjective( si )
      , bp::wrapper< ompl::base::MinimaxObjective >(){
        // constructor
...
void register_MinimaxObjective_class(){
    ...
    { //::ompl::base::MinimaxObjective
        typedef bp::class_< MinimaxObjective_wrapper, bp::bases< ompl::base::OptimizationObjective >, boost::noncopyable > MinimaxObjective_exposer_t;
        MinimaxObjective_exposer_t MinimaxObjective_exposer = MinimaxObjective_exposer_t( "MinimaxObjective", bp::init< ompl::base::SpaceInformationPtr const & >(( bp::arg("si") )) );
        bp::scope MinimaxObjective_scope( MinimaxObjective_exposer );
        bp::implicitly_convertible< ompl::base::SpaceInformationPtr const &, ompl::base::MinimaxObjective >();
        { //::ompl::base::MinimaxObjective::combineCosts
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_combineCosts_function_type)( ::ompl::base::Cost,::ompl::base::Cost ) const;
            
            MinimaxObjective_exposer.def( 
                "combineCosts"
                , combineCosts_function_type(&::ompl::base::MinimaxObjective::combineCosts)
                , default_combineCosts_function_type(&MinimaxObjective_wrapper::default_combineCosts)
                , ( bp::arg("c1"), bp::arg("c2") ) );
        ...
        { //::ompl::base::MinimaxObjective::motionCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_motionCost_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            MinimaxObjective_exposer.def( 
                "motionCost"
                , motionCost_function_type(&::ompl::base::MinimaxObjective::motionCost)
                , default_motionCost_function_type(&MinimaxObjective_wrapper::default_motionCost)
                , ( bp::arg("s1"), bp::arg("s2") ) );
        ...
        { //::ompl::base::OptimizationObjective::averageStateCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_averageStateCost_function_type)( unsigned int ) const;
            
            MinimaxObjective_exposer.def( 
                "averageStateCost"
                , averageStateCost_function_type(&::ompl::base::OptimizationObjective::averageStateCost)
                , default_averageStateCost_function_type(&MinimaxObjective_wrapper::default_averageStateCost)
                , ( bp::arg("numStates") ) );
        ...
        { //::ompl::base::OptimizationObjective::getCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_getCost_function_type)( ::ompl::base::Path const & ) const;
            
            MinimaxObjective_exposer.def( 
                "getCost"
                , getCost_function_type(&::ompl::base::OptimizationObjective::getCost)
                , default_getCost_function_type(&MinimaxObjective_wrapper::default_getCost)
                , ( bp::arg("path") ) );
        ...
        { //::ompl::base::OptimizationObjective::identityCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_identityCost_function_type)(  ) const;
            
            MinimaxObjective_exposer.def( 
                "identityCost"
                , identityCost_function_type(&::ompl::base::OptimizationObjective::identityCost)
                , default_identityCost_function_type(&MinimaxObjective_wrapper::default_identityCost) );
        ...
        { //::ompl::base::OptimizationObjective::infiniteCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_infiniteCost_function_type)(  ) const;
            
            MinimaxObjective_exposer.def( 
                "infiniteCost"
                , infiniteCost_function_type(&::ompl::base::OptimizationObjective::infiniteCost)
                , default_infiniteCost_function_type(&MinimaxObjective_wrapper::default_infiniteCost) );
        ...
        { //::ompl::base::OptimizationObjective::initialCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_initialCost_function_type)( ::ompl::base::State const * ) const;
            
            MinimaxObjective_exposer.def( 
                "initialCost"
                , initialCost_function_type(&::ompl::base::OptimizationObjective::initialCost)
                , default_initialCost_function_type(&MinimaxObjective_wrapper::default_initialCost)
                , ( bp::arg("s") ) );
        ...
        { //::ompl::base::OptimizationObjective::isCostBetterThan
            ...
            typedef bool ( MinimaxObjective_wrapper::*default_isCostBetterThan_function_type)( ::ompl::base::Cost,::ompl::base::Cost ) const;
            
            MinimaxObjective_exposer.def( 
                "isCostBetterThan"
                , isCostBetterThan_function_type(&::ompl::base::OptimizationObjective::isCostBetterThan)
                , default_isCostBetterThan_function_type(&MinimaxObjective_wrapper::default_isCostBetterThan)
                , ( bp::arg("c1"), bp::arg("c2") ) );
        ...
        { //::ompl::base::OptimizationObjective::isSatisfied
            ...
            typedef bool ( MinimaxObjective_wrapper::*default_isSatisfied_function_type)( ::ompl::base::Cost ) const;
            
            MinimaxObjective_exposer.def( 
                "isSatisfied"
                , isSatisfied_function_type(&::ompl::base::OptimizationObjective::isSatisfied)
                , default_isSatisfied_function_type(&MinimaxObjective_wrapper::default_isSatisfied)
                , ( bp::arg("c") ) );
        ...
        { //::ompl::base::OptimizationObjective::isSymmetric
            ...
            typedef bool ( MinimaxObjective_wrapper::*default_isSymmetric_function_type)(  ) const;
            
            MinimaxObjective_exposer.def( 
                "isSymmetric"
                , isSymmetric_function_type(&::ompl::base::OptimizationObjective::isSymmetric)
                , default_isSymmetric_function_type(&MinimaxObjective_wrapper::default_isSymmetric) );
        ...
        { //::ompl::base::OptimizationObjective::motionCostHeuristic
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_motionCostHeuristic_function_type)( ::ompl::base::State const *,::ompl::base::State const * ) const;
            
            MinimaxObjective_exposer.def( 
                "motionCostHeuristic"
                , motionCostHeuristic_function_type(&::ompl::base::OptimizationObjective::motionCostHeuristic)
                , default_motionCostHeuristic_function_type(&MinimaxObjective_wrapper::default_motionCostHeuristic)
                , ( bp::arg("s1"), bp::arg("s2") ) );
        ...
        { //::ompl::base::OptimizationObjective::stateCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_stateCost_function_type)( ::ompl::base::State const * ) const;
            
            MinimaxObjective_exposer.def( 
                "stateCost"
                , stateCost_function_type(&::ompl::base::OptimizationObjective::stateCost)
                , default_stateCost_function_type(&MinimaxObjective_wrapper::default_stateCost)
                , ( bp::arg("s") ) );
        ...
        { //::ompl::base::OptimizationObjective::terminalCost
            ...
            typedef ::ompl::base::Cost ( MinimaxObjective_wrapper::*default_terminalCost_function_type)( ::ompl::base::State const * ) const;
            
            MinimaxObjective_exposer.def( 
                "terminalCost"
                , terminalCost_function_type(&::ompl::base::OptimizationObjective::terminalCost)
                , default_terminalCost_function_type(&MinimaxObjective_wrapper::default_terminalCost)
                , ( bp::arg("s") ) );
